 ...
 */
final class Version20250807200808 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE messanger (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, team_id INT NOT NULL, content LONGTEXT NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_17AAE5C1A76ED395 (user_id), INDEX IDX_17AAE5C1296CD8AE (team_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE messanger ADD CONSTRAINT FK_17AAE5C1A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE messanger ADD CONSTRAINT FK_17AAE5C1296CD8AE FOREIGN KEY (team_id) REFERENCES team (id)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE messanger DROP FOREIGN KEY FK_17AAE5C1A76ED395
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE messanger DROP FOREIGN KEY FK_17AAE5C1296CD8AE
        SQL);
        $this->addSql(<<<'SQL'
