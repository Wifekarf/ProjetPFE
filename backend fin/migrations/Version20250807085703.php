 ...
 */
final class Version20250807085703 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE affect_user_prog_problem ADD team_session_id INT DEFAULT NULL, CHANGE user_id user_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE affect_user_prog_problem DROP team_session_id, CHANGE user_id user_id INT DEFAULT NULL
        SQL);
    }
}
